					...
					<template slot="left">
						<indicator-container name="Statement of Funds">
							<template slot>
								...
								<indicator-item
									:amount="dashboard.reserved_funds.value.amount | currency(dashboard.reserved_funds.value.currency_code)"
									:amountIcon="!!dashboard.reserved_funds.icon"
									:infoIcon="!!dashboard.reserved_funds.tooltip_display_name"
									:name="dashboard.reserved_funds.display_name"
									:tooltipContent="dashboard.reserved_funds.tooltip_display_name"/>
								<indicator-item
					...
					<template slot="left">
						<indicator-container name="Investment Indicators">
							<template slot>
								...
								<indicator-item
									:amount="dashboard.net_deposits.value.amount | currency(dashboard.net_deposits.value.currency_code)"
								...
								<indicator-item 
									:amount="`${dashboard.cash_drag.percent}%`"
									:amountIcon="!!dashboard.cash_drag.icon"
									:infoIcon="!!dashboard.cash_drag.tooltip_display_name"
									:name="dashboard.cash_drag.display_name"
									:tooltipContent="dashboard.cash_drag.tooltip_display_name"/>
							</template>
						</indicator-container>					
					</template>
					<template slot="rigth">
						<indicator-container :iconInfo="true" name="Net Earnings">
							<template slot>
								<indicator-item color="light-green accent-3"
									amount="12.798 €"
									:amountIcon="!!dashboard.net_earnings_past_365days.icon"
									:infoIcon="!!dashboard.net_earnings_past_365days.tooltip_display_name"
									:name="dashboard.net_earnings_past_365days.display_name"
									:tooltipContent="dashboard.net_earnings_past_365days.tooltip_display_name"
								/>
								<indicator-item color="light-green accent-3"
									:amount="dashboard.net_earnings_past_year.value.amount | currency(dashboard.net_deposits.value.currency_code)"
									:amountIcon="!!dashboard.net_earnings_past_year.icon"
									:infoIcon="!!dashboard.net_earnings_past_year.tooltip_display_name"
									:name="dashboard.net_earnings_past_year.display_name"
									:tooltipContent="dashboard.net_earnings_past_year.tooltip_display_name"					
								/>
								<indicator-item color="light-green accent-3"
									:amount="dashboard.net_earnings_total_funds.value.amount | currency(dashboard.net_deposits.value.currency_code)"
									:amountIcon="!!dashboard.net_earnings_total_funds.icon"
									:infoIcon="!!dashboard.net_earnings_total_funds.tooltip_display_name"
									:name="dashboard.net_earnings_total_funds.display_name"
									:tooltipContent="dashboard.net_earnings_total_funds.tooltip_display_name"								
								/>
							</template>
						</indicator-container>								
					</template>				
...
export default {
	async asyncData () {
		let data = await axios.get('/api/dashboard')
			.then(({ data }) => {
				console.log(data.kpis.table_data)
				return data
			})
